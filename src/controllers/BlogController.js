import {  ReadBlogWithCommentService,CreateBlogService ,
    readBlogService ,editBlogService,deleteBlogService, } from "../services/BlogServices.js";


export const ReadBlogWithCommentController = async (req, res) => {
    try {
        let result = await ReadBlogWithCommentService(req, res);
